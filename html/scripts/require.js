    ...
    function ma(b) {
        ...
        function A(a, b) {
            ...
            if (b) b(a);
                ...
                (y(c, function (b) {
                    if ((b = e(t, b)))
                        (b.error = a),
                            b.events.error && ((h = !0), b.emit("error", a));
                }),
                !h)
            )
                g.onError(a);
        ...
        function H() {
            var a,
                ...
                c =
                    (a = 1e3 * p.waitSeconds) &&
                    l.startTime + a < new Date().getTime(),
                h = [],
                k = [],
                f = !1,
                g = !0;
                ...
                a.packages &&
                    y(a.packages, function (a) {
                        ...
                        p.pkgs[b] =
                            a.name +
                            "/" +
                            (a.main || "main").replace(na, "").replace(U, "");
                    });
                D(t, function (a, b) {
            ...
            makeRequire: function (a, n) {
                function m(c, d, f) {
                    ...
                    if ("string" === typeof c) {
                        if (K(d))
                            return A(
                                F("requireargs", "Invalid require call"),
                                f
                            );
